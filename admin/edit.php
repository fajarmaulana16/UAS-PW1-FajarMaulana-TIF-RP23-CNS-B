...
if (isset($_POST["submit"])) {
    ...
    $namaFileBaru = $fotoLama; // Default to old photo
    ...
    $query = "UPDATE produk SET nama = '$nama', merk = '$merk', harga = '$harga', stok = '$stok', foto = '$namaFileBaru' WHERE id = $id";
...
<head>
    ...
    <title>Edit Produk - Toko Sepatu</title>
        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            <div class="page-header" data-aos="fade-down">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h1><i class="bi bi-pencil me-3"></i>Edit Produk</h1>
                        <p class="mb-0 mt-2">Perbarui informasi produk sepatu</p>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="nama" name="nama" 
                                           value="<?= $produk['nama']; ?>" placeholder="Masukkan nama sepatu" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="merk" name="merk" 
                                           value="<?= $produk['merk']; ?>" placeholder="Masukkan merk sepatu" required>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="harga" name="harga" 
                                           value="<?= $produk['harga']; ?>" placeholder="0" min="0" required>
                                </div>
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" class="form-control" id="stok" name="stok" 
                                           value="<?= $produk['stok']; ?>" placeholder="0" min="0" required>
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div id="upload_section">
                                    <div class="file-upload" id="fileUpload">
                                        ...
                                        <h5 class="text-muted">Upload Foto Produk Baru</h5>
                                    ...
                                    <img id="preview" class="preview-img d-none" alt="Preview" style="max-width: 300px; border-radius: 10px; margin-top: 10px;">
                                    <div class="text-center mt-3">
                                        <small class="text-muted">Foto saat ini:</small><br>
                                        <img src="../assets/img/<?= $produk['foto']; ?>" class="current-image" alt="Current Image">
                                    </div>
                                </div>
                                ...
                                <div id="url_section" style="display: none;">
                                    ...
                                    <img id="url_preview" class="preview-img d-none mt-2" alt="URL Preview" style="max-width: 300px; border-radius: 10px;">
                                    <div class="text-center mt-3">
                                        <small class="text-muted">Foto saat ini:</small><br>
                                        <img src="../assets/img/<?= $produk['foto']; ?>" class="current-image" alt="Current Image">
                                    </div>
    ...
    if (input.files && input.files[0]) {
        ...
        reader.onload = function(e) {
            ...
            fileUpload.innerHTML = `
                ...
                <h5 class="text-success">Foto dipilih</h5>
                <p class="text-muted small">${input.files[0].name}</p>
            `;
        };
...
document.querySelectorAll('input[name="foto_type"]').forEach(radio => {
    radio.addEventListener('change', function() {
        ...
        if (this.value === 'upload') {
            ...
            urlInput.required = false; // Optional for edit
            // Reset file input
            fileInput.value = '';
